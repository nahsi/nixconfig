...
| Boundary validation | Parse where data crosses in, into a named domain type. `Record<string, unknown>` (however spelled) stops at that parse. Trust types inside. See the [**boundary-discipline**](skill://principle-boundary-discipline) principle skill. |
