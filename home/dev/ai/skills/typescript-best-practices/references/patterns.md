...
Code examples for each rule in `SKILL.md`. The underlying principles are language-agnostic. See the [**type-system-discipline**](skill://principle-type-system-discipline) and [**boundary-discipline**](skill://principle-boundary-discipline) principle skills.
...
Validate once where data crosses in. Trust types inside. See the [**boundary-discipline**](skill://principle-boundary-discipline) principle skill.
