...
3. Plan the fix from the trace. If it crosses a function boundary, `architect` first. Delegate implementation to the OMP `task` agent; review the diff. Capture a post-fix trace.
