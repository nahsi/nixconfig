...
The sequencing complement to the [**prove-it-works**](skill://principle-prove-it-works) principle skill, which keeps each check real, and the [**build-the-lever**](skill://principle-build-the-lever) principle skill, which makes the per-unit check cheap.
