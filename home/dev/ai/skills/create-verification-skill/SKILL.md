...
Point the user at [`/maintain-verification-skill`](skill://maintain-verification-skill) for keeping the map honest as the app changes. Suggest a cadence only if they ask.
