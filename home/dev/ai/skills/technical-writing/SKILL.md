...
description: "Layered technical-writing standard for docs, RFCs, readmes, PR descriptions, and commit messages. Invoke with /skill:technical-writing."
...
- Read and apply `skill://unslop` to every document this skill touches. Unslop owns the slop-pattern catalog.
