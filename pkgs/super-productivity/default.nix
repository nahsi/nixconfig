...
buildNpmPackage rec {
  ...
  # Pinned to 18.9.1, not latest: 18.10.0 hardened plugin nodeExecution grants
  # such that only app-bundled plugins may execute Node, blocking the
  # side-loaded MCP bridge plugin. 18.9.1 is the last release before that.
  version = "18.9.1";
